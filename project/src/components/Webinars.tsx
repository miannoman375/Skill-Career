          ...
          >
            {webinars.map((wb, i) => (
              <article
                ...
                className="card flex flex-col p-5 hover:-translate-y-1 hover:border-coral-200"
              >
          ...
          <div className="p-6 sm:p-7">
            {registered === selected.id ? (
              <div className="flex flex-col items-center py-8 text-center">
                ...
                <h3 className="mt-4 text-xl font-bold">Seat saved!</h3>
              ...
              <>
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 id="wb-title" className="text-lg font-bold">
                      {selected.title}
                    </h3>
