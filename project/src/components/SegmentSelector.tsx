                  ...
                  <div className="flex items-start justify-between">
                    ...
                    <button
                      ...
                      className={`text-xs font-semibold transition-colors ${
                        isActive ? 'text-green-600' : 'text-ink-muted hover:text-indigo-500'
                      }`}
                    >
                      {isActive ? 'Selected' : 'Select'}
                    </button>
                  </div>
                  <h3 className="mt-4 text-lg font-bold text-ink">{seg.label}</h3>
                  <p className="mt-2 text-sm leading-relaxed text-ink-soft">{seg.blurb}</p>
                  <AuthLink
                    to="/signup"
                    className="mt-4 inline-flex items-center gap-1 text-sm font-semibold text-indigo-500 transition-colors hover:text-coral-400"
                  >
                    Get started
