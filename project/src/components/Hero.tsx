...
// Purane saved data mein primary CTA abhi bhi /signup ho sakta hai. Login/Signup
// pages permanently hataye ja chuke hain, to aise links ko assessment CTA par
// map kar dete hain taake koi bhi user dead page na khole.
function safeCtaLink(link: string): string {
  return link === '/login' || link === '/signup' ? '/#assessment' : link;
}
        ...
        <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-12">
          <div className="animate-fade-up">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center">
              <Link to={safeCtaLink(hero.primary_cta_link)} className="btn-primary text-base">
                {hero.primary_cta_text}
                <ArrowRight className="h-4 w-4" />
              </Link>
              <Link to={safeCtaLink(hero.secondary_cta_link)} className="btn-ghost text-base">
          ...
          <div className="relative animate-fade-in [animation-delay:200ms]">
            <div className="relative mx-auto max-w-md lg:max-w-none">
              <div className="overflow-hidden rounded-2xl border border-line bg-white shadow-[0_8px_30px_rgba(10,14,63,0.08)]">
                {loading ? (
